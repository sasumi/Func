 ...
 * @param array $curl_option
 * @param bool $override Whether to override option or patch only
 */
function curl_set_default_option(array $curl_option, $override = false){
	$default = !$override ? curl_get_default_option() : [];
